...
public class CoffeeCupProgram {
	...
	private void part1(){
		...
		/* cup.drinkCoffee(40); //currentV er 5, så går ikke.drinkCoffee(double).
		cup.drinkCoffee(Math.ceil(r.nextDouble()*42)); 
		cup.drinkCoffee(Math.floor(r.nextDouble()*20.5));*/ 
		cup.fillCoffee(32.5);
		cup.drinkCoffee(Math.ceil(r.nextDouble()*38.9));
	...
	private void part2(){
		...
		//cup.fillCoffee(Math.ceil(r.nextDouble()*59)); //cap = 40, currentV = 6.5
		//cup.drinkCoffee(Math.ceil(r.nextDouble()*42)); //cap = 40, vol = 6.5
